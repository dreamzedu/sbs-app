...
public class SurveyListActivity extends AppCompatActivity implements IAsyncTaskInvoker{
    ...
    public void OnBeforeExecute(String httpAction) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                progress = new ProgressDialog(SurveyListActivity.this);
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(SurveyListActivity.this);
