...
import com.example.sbs.data.Result;
...
public class LoginViewModel extends ViewModel {
    ...
    LoginViewModel(Context context) {
        this.loginRepository = LoginRepository.getInstance(context);
    }
    ...
    public void login(String username, String password) {
        ...
        if (result instanceof Result.Success) {
            ...
            loginResult.setValue(new LoginResult(new LoggedInUserView(data.getDisplayName(), data.getRoleId())));
        } else {
            String err = ((Result.Error)result).getError().getMessage();
